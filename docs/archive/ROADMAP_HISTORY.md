# Roadmap history (v0.2 through v0.22.2)

This page is a frozen record of the milestone plans and release snapshots that
shaped the project from `v0.2` through the `v0.22.2` maintenance release. It is
kept for reference only; the active planning view is
[`docs/ROADMAP.md`](../ROADMAP.md), and the release history is in
`CHANGELOG.md`.

The oldest milestone notes are in [`V0_2_ROADMAP.md`](./V0_2_ROADMAP.md).

Detailed execution plans from those cycles:

- [`docs/archive/V0_3_X_PLAN.md`](./V0_3_X_PLAN.md)
- [`docs/archive/V0_4_PROFILE_PLAN.md`](./V0_4_PROFILE_PLAN.md)
- [`docs/archive/V0_5_QUANTASTOR_PLAN.md`](./V0_5_QUANTASTOR_PLAN.md)
- [`docs/archive/V0_8_HISTORY_PLAN.md`](./V0_8_HISTORY_PLAN.md)
- [`docs/archive/V0_9_0_PLAN.md`](./V0_9_0_PLAN.md)
...
- deferred follow-ups were carried into the next cycle, with
...
- [`docs/archive/DEMO_SITE_PLAN.md`](./DEMO_SITE_PLAN.md)
