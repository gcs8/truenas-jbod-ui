...
- Backup and restore paths have stronger archive, manifest, size, integrity, and transactional rollback checks. Portable encrypted 7z passphrases no longer appear in child-process arguments, and bounded FULL backups now support history databases above 1 GiB with a 10-minute, single-thread archive profile.
