...
| Deployment refresh/sniff tests | yes | local Windows Docker recreated from GHCR `latest`, UI/history/admin livez `0.20.2`, health ok, digest `sha256:b032de57f8e66ed13164ab6409933e401fbd78a921f69d5cd3eb0dad6bf6603f`, primary UI smoke passed; Linux restored QA stack recreated from GHCR `latest` on `192.0.2.138:18080/18081/18082`, UI/history/admin livez `0.20.2`, health ok, digest matched, primary UI smoke passed; production `http://198.51.100.10:42069` and local history `42070` recreated from GHCR `latest`, UI/history livez `0.20.2`, digest matched, forced inventory warmed `60` slots, UI health ok, primary UI smoke passed | Pass |  |
