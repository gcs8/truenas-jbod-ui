...
class SnapshotExportServiceTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_service_builds_self_contained_html_snapshot(self) -> None:
        ...
        self.assertIn("Offline copy", rendered.html)
        self.assertIn("This is a saved copy, not live data.", rendered.html)
        self.assertIn("About this copy", rendered.html)
        ...
        self.assertNotIn("Frozen Offline Artifact", rendered.html)
        self.assertNotIn("Explorable Enclosure Snapshot", rendered.html)
        self.assertNotIn("Artifact app v", rendered.html)
